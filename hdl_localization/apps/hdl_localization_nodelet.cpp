...
public:
  ...
  void onInit() override {
    ...
    robot_odom_frame_id = private_nh.param<std::string>("robot_odom_frame_id", "base_link"); //robot_odom->velodyne
    odom_child_frame_id = private_nh.param<std::string>("odom_child_frame_id", "velodyne"); //base->robot
    blind = private_nh.param<std::float_t>("blind", 0.02);
