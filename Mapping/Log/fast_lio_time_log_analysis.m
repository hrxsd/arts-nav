...
mapping_ikdtree = csvread("./mapping_time_log.csv",1,0);
timestamp_ikd = mapping_ikdtree(:,1);
timestamp_ikd = timestamp_ikd - min(timestamp_ikd);
total_time_ikd = mapping_ikdtree(:,2)*1e3;
scan_num = mapping_ikdtree(:,3);
incremental_time_ikd = mapping_ikdtree(:,4)*1e3;
search_time_ikd = mapping_ikdtree(:,5)*1e3;
delete_size_ikd = mapping_ikdtree(:,6);
delete_time_ikd = mapping_ikdtree(:,7) * 1e3;
tree_size_ikd_st = mapping_ikdtree(:,8);
tree_size_ikd = mapping_ikdtree(:,9);
add_points = mapping_ikdtree(:,10);

mapping_forest = csvread("mapping_time_log.csv",1,0);
fov_check_time_forest = mapping_forest(:,5)*1e3;
average_time_forest = mapping_forest(:,2)*1e3;
total_time_forest = mapping_forest(:,6)*1e3;
incremental_time_forest = mapping_forest(:,3)*1e3;
search_time_forest = mapping_forest(:,4)*1e3;
timestamp_forest = mapping_forest(:,1);
